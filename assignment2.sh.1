...
# Ensure sudo package and sudo group exist
...
# Check and start apache2 if not running
...
# Check and start squid if not running
if ! systemctl is-active --quiet squid; then
    systemctl enable squid
    systemctl start squid
    echo "Started squid service."
else
    echo "squid service is already running."
fi
